...
%% Divide data into 20 second sections

if rec_time > 20;

uiwait(msgbox({'Data selected is too long to analyze.' 'Click where you wish to separate the data into two data sets. Be sure to avoid breaking up a phrase between two data sets.' 'Each data set must be fewer than 20 seconds in length.' 'Press the Return key when finished.'},'modal'));
[divpt_x divpt_y] = ginput;
%identify first half and second half; divide into data sets
vv = 1;
ww = 1;
for yy = 1:length(time_max_peak)
    if time_max_peak(yy) < divpt_x
        time_max_peak1(vv) = time_max_peak(yy);
        max_pks1(vv) = max_pks(yy);
        vv = vv+1;
    else
        time_max_peak2(ww) = time_max_peak(yy);
        max_pks2(ww) = max_pks(yy);
        ww = ww+1;
    end
end
aa = 1;
bb = 1;
for cc = 1:length(time_speech_loc_2)
    if time_speech_loc_2(cc) < divpt_x
        time_speech_loc_2_1(aa) = time_speech_loc_2(cc);
        speech_loc_2_1(aa) = speech_loc_2(cc);
        speech_pk_2_1(aa) = speech_pk_2(cc);
        aa = aa + 1;
    else
        time_speech_loc_2_2(bb) = time_speech_loc_2(cc);
        speech_loc_2_2(bb) = speech_loc_2(cc);
        speech_pk_2_2(bb) = speech_pk_2(cc);
        bb = bb + 1;
    end
end
div_ind = divpt_x*sampling_rate;
t_divpt = find( t > divpt_x-(t_btwn_pts_y3/2) & t < divpt_x+(t_btwn_pts_y3/2));
t1 = t(1:t_divpt);
y3_1 = y3(1:t_divpt);
t2 = t(t_divpt+1:end);
y3_2 = y3(t_divpt+1:end);

%%Peak correction -- divided data
...
section2_pks_1 = max_pks1(section1_divpt_1+1:end);

ff = 1;
gg = 1;
for hh = 1:length(time_speech_loc_2_1)
    if time_speech_loc_2_1(hh) <= section1_t_1(end)
        section1_speech_t_1(ff) = time_speech_loc_2_1(hh);
        section1_speech_loc_1(ff) = speech_loc_2_1(hh);
        section1_speech_pk_2_1(ff) = speech_pk_2_1(hh);
        ff = ff+1;
    else
        section2_speech_t_1(gg) = time_speech_loc_2_1(hh);
        section2_speech_loc_1(gg) = speech_loc_2_1(hh);
        section2_speech_pk_2_1(gg) = speech_pk_2_1(hh);
        gg = gg+1;
    end
end
...
section2_pks_2 = max_pks2(section1_divpt_2+1:end);

ff = 1;
gg = 1;
for hh = 1:length(time_speech_loc_2_2)
    if time_speech_loc_2_2(hh) <= section1_t_2(end)
        section1_speech_t_2(ff) = time_speech_loc_2_2(hh);
        section1_speech_loc_2(ff) = speech_loc_2_2(hh);
        section1_speech_pk_2_2(ff) = speech_pk_2_2(hh);
        ff = ff+1;
    else
        section2_speech_t_2(gg) = time_speech_loc_2_2(hh);
        section2_speech_loc_2(gg) = speech_loc_2_2(hh);
        section2_speech_pk_2_2(gg) = speech_pk_2_2(hh);
        gg = gg+1;
    end
end
...
if q_adjust == ['No ']
    ...
    if q_adjust1 == ['No ']
        ...
        figure(4);
        subplot(2,1,1);
        plot(section1_t_1, section1_pks_1,'m');
    ...
    elseif q_adjust1 == ['Yes']
        ...
        section1_speech_t_1 = section1_speech_t_1;
        section1_speech_pk_2_1 = section1_speech_pk_2_1;
    end
    figure(4);
    subplot(2,1,1);
    ...
    [row col] = size(section1_speech_t_1);
    if row ~= 1
        section1_speech_t_1 = section1_speech_t_1';
    end
    [row col] = size(section1_speech_pk_2_1);
    if row ~= 1
        section1_speech_pk_2_1 = section1_speech_pk_2_1';
    end
    %first data set, second half
    subplot(2,1,2);
    plot(section2_t_1, section2_pks_1,'m',section2_speech_t_1,section2_speech_pk_2_1,'gx');
    ...
    elseif q_adjust2 == ['Yes']
        ...
        section2_speech_t_1 = section2_speech_t_1;
        section2_speech_pk_2_1 = section2_speech_pk_2_1;
    end
    figure(4);
    subplot(2,1,2);
    plot(section2_t_1, section2_pks_1,'m',section2_speech_t_1,section2_speech_pk_2_1,'bx');
    [row col] = size(section2_speech_loc_1);
    if row ~= 1
        section2_speech_loc_1 = section2_speech_loc_1';
    end
    [row col] = size(section2_speech_t_1);
    if row ~= 1
        section2_speech_t_1 = section2_speech_t_1';
    end
    [row col] = size(section2_speech_pk_2_1);
    if row ~= 1
        section2_speech_pk_2_1 = section2_speech_pk_2_1';
    end
    clear time_speech_loc_2_1 speech_pk_2_1 speech_loc_2_1
    %concatenate correct peaks
    speech_loc_2_1 = [section1_speech_loc_1 section2_speech_loc_1];
    time_speech_loc_2_1 = [section1_speech_t_1 section2_speech_t_1];
    speech_pk_2_1 = [section1_speech_pk_2_1 section2_speech_pk_2_1];
elseif q_adjust == ['Yes']
    speech_loc_2_1 = speech_loc_2_1;
    time_speech_loc_2_1 = time_speech_loc_2_1;
...
if q_adjust == ['No ']
    ...
    if q_adjust1 == ['No ']
        ...
        figure(4);
        subplot(2,1,1);
        plot(section1_t_2, section1_pks_2,'m');
        %if peaks aren't correct, clear previous data and hand select
        %correct points
    ...
    [row col] = size(section1_speech_t_2);
    if row ~= 1
        section1_speech_t_2 = section1_speech_t_2';
    end
    [row col] = size(section1_speech_pk_2_2);
    if row ~= 1
        section1_speech_pk_2_2 = section1_speech_pk_2_2';
    end
    %second data set, second half
    subplot(2,1,2);
    plot(section2_t_2, section2_pks_2,'m',section2_speech_t_2,section2_speech_pk_2_2,'gx');
    q_adjust2 = questdlg('Are the green peaks correct?','Hand Adjustment 2','Yes','No ','Yes');
    if q_adjust2 == ['No ']
        uiwait(msgbox({'Click on the correct speech peaks for the entire waveform.' 'Emphasis should be given to time values (x-axis) rather than peak amplitude (y-axis).' 'Press the Return key when finished.'},'modal'));
        figure(4);
    ...
    [row col] = size(section2_speech_t_2);
    if row ~= 1
        section2_speech_t_2 = section2_speech_t_2';
    end
    [row col] = size(section2_speech_pk_2_2);
    if row ~= 1
        section2_speech_pk_2_2 = section2_speech_pk_2_2';
    end
    clear time_speech_loc_2_2 speech_pk_2_2 speech_loc_2_2
    %concatenate correct peaks
    speech_loc_2_2 = [section1_speech_loc_2 section2_speech_loc_2];
    time_speech_loc_2_2 = [section1_speech_t_2 section2_speech_t_2];
    speech_pk_2_2 = [section1_speech_pk_2_2 section2_speech_pk_2_2];
elseif q_adjust == ['Yes']
    speech_loc_2_2 = speech_loc_2_2;
    time_speech_loc_2_2 = time_speech_loc_2_2;
    speech_pk_2_2 = speech_pk_2_2;
end
...
speech_loc_resample_t2 = speech_loc_resample2*step_resample2-step_resample2;
...
for kk = 1:length(speech_pk_2_1)
   ...
   if length(ind_found) == 2
       ...
       for ll = 2:length(ind_found)
           if ind_found(ll) < speech_loc_resample1(kk) 
               ind_60_1(kk) = ind_found(ll);
           end
       end
   end
end
...
for kk = 1:length(speech_pk_2_2)
   ...
   if length(ind_found) == 2
       ...
       for ll = 2:length(ind_found)
           if ind_found(ll) < speech_loc_resample2(kk) 
               ind_60_2(kk) = ind_found(ll);
           end
       end
   end
end
...
z = 1;
for zz = 1:length(ind_60_1)
    if ind_60_1(zz) ~= 0
        ind_60_new1(z) = ind_60_1(zz);
        z = z+1;
    end
end
...
for mm = 1:length(ind_60_new1)
    t_60_1(mm) = ind_60_new1(mm)*step_resample1-step_resample1;
...
figure(3);
hold on;
plot(time_max_peak,max_pks,'m',t_60,amp_60,'kx');
title('Speech Beats');
hold off;
