...
%Enter inputs.
prompts = {'Enter Speech File Name: ','Enter Metronome Track Name: ','Enter Metronome Type: ','Enter Metronome BPM: '};
inputbox_title = 'Inputs';
num_lines = 1;
inputs = inputdlg(prompts, inputbox_title, num_lines);

speech_file = inputs{1};
metronome_track = inputs{2};
metronome_type_input = inputs{3};
metronome_bpm_input = inputs{4};
