...
for m=1:length(S)
    suj=S{m};
    filename = cat(2,suj,'_SLIR_difwavSVA_ERP.mat')
...
for m=1:length(S)
    ...
    cfg.channel = 'E73'; % NOT pz... trying a more posterior channel

    cfg.toilim = time;
    trimdata = ft_selectdata(ERPdata{m},'toilim',time,'channel', 'E62','avgoverchan','no','avgovertime','yes')
