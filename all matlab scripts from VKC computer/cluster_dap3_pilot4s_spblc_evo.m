...
for b=1:length(bin)
    ...
    filename = cat(2,'dap3_',bin{b}, '_allSubj_4s_avblc_evo.mat')
    load(filename);
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save dap3_regvsirr_4s_spblc_evo_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save dap3_regvsirr_4s_spblc_evo_gam_stat.mat stat
clear stat
