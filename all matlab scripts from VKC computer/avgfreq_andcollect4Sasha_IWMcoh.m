...
bin{1}='task'; % all 3 bins together
bin{2}='base';
...
outfilename = 'IWMCoh_Bellchanpairs_TaskvsBase.txt' % 
fid = fopen(outfilename,'w');

%headerline with channel pairs:
fprintf(fid, 'Fp1-F3\t Fp2-F4\t F3-F7\t F4-F8\t F3-P3\t P3-P4\t F3-O1\t F4-O2\t Fp1-F3\t Fp2-F4\t F3-F7\t F4-F8\t F3-P3\t P3-P4\t F3-O1\t F4-O2\t \n');

dlmwrite('IWMCoh_Bellchanpairs_TaskvsBase.txt',BigTable,'delimiter','\t','precision','%.4f','-append')
