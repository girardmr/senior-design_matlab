...
clustercode = cat(2,'MAPmatchdifCampvsCtrl',band,'4paper'); % give some abbreviation for your cluster, which will be used to name the graphics files

load MAP_campvsctrl_Matchdif_evo_beta_stat
...
%define latsnaps and zscale by hand. This cluster's latency is: 204 to 356ms
latsnaps = [348 400 448]; % want "snapshots" at these latencies for this cluster - in ms
...
cfg.layout = layout;
%cfg.elec = stat.label; %unnecessary
cfg.yparam = 'freq';
cfg.ylim= freqband;
cfg.zlim = zscale;
cfg.baseline = 'no';
...
cfg.ylim         = [13 55]; % could also use instead cfg.ylim = freqband 
