...
stat.cond1 = bin{1}
stat.cond2 = bin{2}
save Metronew_beatvsoff_theta_ind_stat.mat stat
clear stat
...
stat.cond1 = bin{1}
stat.cond2 = bin{2}
save Metronew_beatvsoff_alf_ind_stat.mat stat
clear stat
...
stat.cond1 = bin{1}
stat.cond2 = bin{2}
save Metronew_beatvsoff_beta_ind_stat.mat stat
clear stat
...
stat.cond1 = bin{1}
stat.cond2 = bin{2}
save Metronew_beatvsoff_logam_ind_stat.mat stat
clear stat