...
load CDT_ctrl_Words_evo_alf_stat
...
load(cat(2,'CDT_controls_',cond1, '_gravg_avblc_evo.mat'));
% use grand average files
bin1 = TFgravg_evo;
clear TFgravg_evo

load(cat(2,'CDT_controls_',cond2, '_gravg_avblc_evo.mat'));
bin2 = TFgravg_evo;
clear TFgravg_evo
...
latsnaps = [250 300 400 450]; % want "snapshots" at these latencies for this cluster - in ms
...
A= 0:2:800; % careful here: specify timepoints in ms that were used in clustering analysis. 
