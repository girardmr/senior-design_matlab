...
clustercode = cat(2,'MAPcamp1vs2_',band,'4paper'); % give some abbreviation for your cluster, which will be used to name the graphics files
...
load(cat(2,'MAP_campers_',cond1, '_gravg_avblc_ind.mat'));
% use grand average files
bin1 = TFgravg_ind;
clear TFgravg_ind

load(cat(2,'MAP_campers_',cond2, '_gravg_avblc_ind.mat'));
bin2 = TFgravg_ind;
clear TFgravg_ind
...
latsnaps = [300 400 500]; % want "snapshots" at these latencies for this cluster - in ms
