...
clustercode = cat(2,'MAPctrl1vs3',band); % give some abbreviation for your cluster, which will be used to name the graphics files

load MAPctrl_1vs3_ERP_stat.mat % make sure you load the right stat file
