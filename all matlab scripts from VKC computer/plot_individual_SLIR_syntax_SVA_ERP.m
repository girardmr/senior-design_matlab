...
saveas(gcf, 'ERP subject average multichan, SLIR_101_syntax_SVA', 'fig'); % save as a Matlab Figure file
%saveas(gcf, 'ERP subject average multichan, SLIR_101_syntax_SVA', 'jpg'); % save as a jpeg file
...
legend('Subject-Verb Correct','Subject-Verb Violation');
...
saveas(gcf, 'ERP subject average Pz, SLIR_101_syntax_SVA', 'fig'); % save as a Matlab Figure file
%saveas(gcf, 'ERP subject average Pz, SLIR_101_syntax_SVA', 'jpg'); % save as a jpeg file
...
saveas(gcf, 'ERP subject average multichan, SLIR_102_syntax_SVA', 'fig'); % save as a Matlab Figure file
%saveas(gcf, 'ERP subject average multichan, SLIR_102_syntax_SVA', 'jpg'); % save as a jpeg file
...
saveas(gcf, 'ERP subject average Pz, SLIR_102_syntax_SVA', 'fig'); % save as a Matlab Figure file
%saveas(gcf, 'ERP subject average Pz, SLIR_102_syntax_SVA', 'jpg'); % save as a jpeg file
...
load(cat(2,'SLIR_103_', bin{1}, '_syntax_lpf_ERP_blc.mat'));
bin1 = data;
clear data
...
saveas(gcf, 'ERP subject average multichan, SLIR_103_syntax_SVA', 'fig'); % save as a Matlab Figure file
%saveas(gcf, 'ERP subject average multichan, SLIR_103_syntax_SVA', 'jpg'); % save as a jpeg file
...
saveas(gcf, 'ERP subject average Pz, SLIR_103_syntax_SVA', 'fig'); % save as a Matlab Figure file
%saveas(gcf, 'ERP subject average Pz, SLIR_103_syntax_SVA', 'jpg'); % save as a jpeg file
...
saveas(gcf, 'ERP subject average multichan, SLIR_104_syntax_SVA', 'fig'); % save as a Matlab Figure file
%saveas(gcf, 'ERP subject average multichan, SLIR_104_syntax_SVA', 'jpg'); % save as a jpeg file
...
saveas(gcf, 'ERP subject average Pz, SLIR_104_syntax_SVA', 'fig'); % save as a Matlab Figure file
%saveas(gcf, 'ERP subject average Pz, SLIR_104_syntax_SVA', 'jpg'); % save as a jpeg file
