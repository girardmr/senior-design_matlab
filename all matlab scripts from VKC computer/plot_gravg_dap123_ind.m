...
for b=1:length(bin) %for each condition specified above
    ...
    filename = cat(2,'dap123_',bin{b}, '_gravg_avblc_ind.mat');
    load(filename)
...
cfg.xlim = [-0.250 0.250] % time 0 to 600ms
...
for b= 1:length(bin)
    ...
    outfile = cat(2,'ind multichan Gravg ',condname{b});
    supertitle(outfile)
...
%     end
%
%     suplabel((cat(2,suj,' indked - Avg Chan')),'t')
%
%     outfilename = cat(2,suj,' bigbins indked avg chan')
%
