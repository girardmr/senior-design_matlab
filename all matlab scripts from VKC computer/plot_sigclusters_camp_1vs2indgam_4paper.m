...
clear all; clc
%this one goes from 
band = 'IndGam';  %for naming purposes, say ERP here or the name of your frequency band of interest
...
latsnaps = [480 520]; % want "snapshots" at these latencies for this cluster - in ms
...
cfg.ylim         = [8 55]; % could also use instead cfg.ylim = freqband 
