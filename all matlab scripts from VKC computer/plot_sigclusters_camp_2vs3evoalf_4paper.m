...
% mod. by RLG 15 feb 2012
%%  NOT SIGNIFICANT
clear all; clc
%this one goes from 
band = 'EvoAlf';  %for naming purposes, say ERP here or the name of your frequency band of interest
clustercode = cat(2,'MAPcamp2vs3_',band,'4paper'); % give some abbreviation for your cluster, which will be used to name the graphics files

load MAPcamp_2vs3_evo_alf_stat.mat
...
latsnaps = [48 100 148 200]; % want "snapshots" at these latencies for this cluster - in ms
...
cfg.ylim         = [8 15]; % could also use instead cfg.ylim = freqband 
