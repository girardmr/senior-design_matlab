...
load(cat(2,bin{1}, '_gravg.mat'));
bin1 = ERPgravg;
clear ERPgravg

load(cat(2,bin{2}, '_gravg.mat'));
bin2 = ERPgravg;
clear ERPgravg
...
saveas(gcf, 'ERP grand average multichan, SLIR_syntax', 'fig'); % save as a Matlab Figure file
saveas(gcf, 'ERP grand average multichan, SLIR_syntax', 'jpg'); % save as a tiff file
...
saveas(gcf, 'ERP grand average Pz, SLIR_syntax', 'fig'); % save as a Matlab Figure file
saveas(gcf, 'ERP grand average Pz, SLIR_syntax', 'jpg'); % save as a tiff file
