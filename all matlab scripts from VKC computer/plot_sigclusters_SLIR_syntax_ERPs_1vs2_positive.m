...
clustercode = cat(2,'syntax_1vs2_pos_',band); % give some abbreviation for your cluster, which will be used to name the graphics files

load SLIR_syntax_1vs2_ERP_stat.mat % make sure you load the right stat file
...
latsnaps = [650 700 750 800 850 900]; % want "snapshots" at these latencies for this cluster - in ms
