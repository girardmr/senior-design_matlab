%cluster evoked data on targets
% mod. by Reyna oct 17, 2010
...
for b=1:length(bin)
    ...
    filename = cat(2,bin{b}, '_chords_allSubj_avblc_evo.mat');
    load(filename);
...
save Chords_1vs2_avblc_evo_the_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{2}, data{3}); %
save Chords_2vs3_avblc_evo_the_stat.mat stat
clear stat

%%
[stat]    = ft_freqstatistics(cfg, data{1}, data{3}); %
save Chords_1vs3_avblc_evo_the_stat.mat stat
clear stat
...
[stat]    = ft_freqstatistics(cfg, data{1}, data{2}); %
save Chords_1vs2_avblc_evo_alf_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{2}, data{3}); %
save Chords_2vs3_avblc_evo_alf_stat.mat stat
clear stat

%%
[stat]    = ft_freqstatistics(cfg, data{1}, data{3}); %
save Chords_1vs3_avblc_evo_alf_stat.mat stat
clear stat
...
save Chords_1vs2_avblc_evo_beta_stat.mat stat
clear stat
%
[stat]    = freqstatistics(cfg, data{2}, data{3}); %
save Chords_2vs3_avblc_evo_beta_stat.mat stat
clear stat

%
[stat]    = ft_freqstatistics(cfg, data{1}, data{3}); %
save Chords_1vs3_avblc_evo_beta_stat.mat stat
clear stat
