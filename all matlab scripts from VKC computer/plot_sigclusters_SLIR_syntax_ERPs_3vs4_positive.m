...
clustercode = cat(2,'syntax_3vs4_pos_',band); % give some abbreviation for your cluster, which will be used to name the graphics files

load SLIR_syntax_3vs4_ERP_stat.mat % make sure you load the right stat file
...
latsnaps = []; % want "snapshots" at these latencies for this cluster - in ms
