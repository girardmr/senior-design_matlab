...
for b=1:length(bin)
    ...
    filename = cat(2,'MAP_controls_',bin{b}, '_allSubj_avblc_ind.mat');
    load(filename);
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save MAPctrl_1vs2_ind_alf_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{2}, data{3}); 
stat.cond1 = bin{2};
stat.cond2 = bin{3};%
save MAPctrl_2vs3_ind_alf_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{3};%
save MAPctrl_1vs3_ind_alf_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{5};
save MAPctrl_4vs5_ind_alf_stat.mat stat
...
stat.cond1 = bin{5};
stat.cond2 = bin{6};%
save MAPctrl_5vs6_ind_alf_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{6};%
save MAPctrl_4vs6_ind_alf_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save MAPctrl_1vs2_ind_beta_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{2}, data{3}); 
stat.cond1 = bin{2};
stat.cond2 = bin{3};%
save MAPctrl_2vs3_ind_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{3};%
save MAPctrl_1vs3_ind_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{5};
save MAPctrl_4vs5_ind_beta_stat.mat stat
...
stat.cond1 = bin{5};
stat.cond2 = bin{6};%
save MAPctrl_5vs6_ind_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{6};%
save MAPctrl_4vs6_ind_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save MAPctrl_1vs2_ind_gam_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{2}, data{3}); 
stat.cond1 = bin{2};
stat.cond2 = bin{3};%
save MAPctrl_2vs3_ind_gam_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{3};%
save MAPctrl_1vs3_ind_gam_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{5};
save MAPctrl_4vs5_ind_gam_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{5}, data{6}); 
stat.cond1 = bin{5};
stat.cond2 = bin{6};%
save MAPctrl_5vs6_ind_gam_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{6};%
save MAPctrl_4vs6_ind_gam_stat.mat stat
clear stat
