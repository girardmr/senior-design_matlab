...
saveas(gcf, 'ERP grand average multichan, SLIR_syntax_both', 'fig'); % save as a Matlab Figure file
saveas(gcf, 'ERP grand average multichan, SLIR_syntax_both', 'jpg'); % save as a jpeg file
...
saveas(gcf, 'ERP grand average Pz, SLIR_syntax_both', 'fig'); % save as a Matlab Figure file
saveas(gcf, 'ERP grand average Pz, SLIR_syntax_both', 'jpg'); % save as a jpeg file
