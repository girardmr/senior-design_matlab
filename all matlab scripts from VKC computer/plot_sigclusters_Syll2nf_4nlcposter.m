...
%of plots
clear all; clc
clustercode = 'Syll2_4nlcposter';
cond1= 'SSreg';
cond2= 'WSreg';
band = 'LoGamma';
% POS cluster, be careful

load SSregvsWSreg_stat_logam_evo_rs_f.mat %make sure this is new stat file

load Strong_Strong_gravg_mblc_evo_rs.mat
bin1 = TFgravg_evo;
clear TFgravg_evo

load Weak_Strong_gravg_mblc_evo_rs.mat
bin2 = TFgravg_evo;
clear TFgravg_evo
...
latsnaps = [-30 0 30]; % want snapshots at these latencies for this cluster in ms
zscale = [-1 1]; % %
%this one goes from -100ms to 50ms
...
% save SigChan_Syll2nf.mat SigChan
