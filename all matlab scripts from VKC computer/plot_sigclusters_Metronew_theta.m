...
load Metronew_beatvsoff_theta_ind_stat.mat %make sure this is new stat file
cond1= stat.cond1;
cond2= stat.cond2;
...
zscale = [-0.15 0.15]; % %
%this one goes from -16ms to 300ms
...
save SigChan_MetronewTheta_ind.mat SigChan
