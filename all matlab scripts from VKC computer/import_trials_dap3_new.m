...
load hdrtemplate_dap3_125.mat %this header template contains sampling rate
...
for m=1:length(S)
    subj=S{m};
    matfilename=cat(2,subj,'.fil.seg.ref.mat') % ref files contain single trials (only good segments post-AD) 
