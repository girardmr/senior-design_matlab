...
%of plots
clear all; clc
clustercode = 'Targ15n_4frontiers';
cond1= 'MAmain';
cond2= 'IRmain';
band = 'indBeta';
...
load Targ_MAvsIR_main_avblc_ind_nbeta_stat.mat
...
%% CAREFUL HERE, THIS IS A NEG CLUSTER SO SUBTRACT INOTHER DIRECTION
difwave = bin2;
difwave.powspctrm = bin2.powspctrm  - bin1.powspctrm;
...
%%
load soprolay_butterflymask.mat
load cmapRWB.mat
...
for k = 1:L %# of subplots
    ...
    chan_temp = Big_mat(:,m(k))==1; %find indices of stat matrix corresponding to the channels
