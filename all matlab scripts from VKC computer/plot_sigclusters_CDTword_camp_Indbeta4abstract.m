...
clustercode = cat(2,'CDTwords_camp_',band,'4PoRT'); % give some abbreviation for your cluster, which will be used to name the graphics files
...
cfg.ylim         = [12 25]; % could also use instead cfg.ylim = freqband 
