...
clustercode = cat(2,'CDTwords_ctrl_',band); % give some abbreviation for your cluster, which will be used to name the graphics files

load CDT_ctrl_Words_ind_beta_stat
...
load(cat(2,'CDT_controls_',cond1, '_gravg_avblc_ind.mat'));
% use grand average files
bin1 = TFgravg_ind;
clear TFgravg_ind

load(cat(2,'CDT_controls_',cond2, '_gravg_avblc_ind.mat'));
bin2 = TFgravg_ind;
clear TFgravg_ind
...
latsnaps = [580 680 780]; % want "snapshots" at these latencies for this cluster - in ms
