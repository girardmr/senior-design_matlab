...
saveas(gcf, 'ERP grand average multichan, SLIR_syntax_SVA', 'fig'); % save as a Matlab Figure file
saveas(gcf, 'ERP grand average multichan, SLIR_syntax_SVA', 'jpg'); % save as a jpeg file
...
saveas(gcf, 'ERP grand average Pz, SLIR_syntax_SVA', 'fig'); % save as a Matlab Figure file
saveas(gcf, 'ERP grand average Pz, SLIR_syntax_SVA', 'jpg'); % save as a jpeg file
