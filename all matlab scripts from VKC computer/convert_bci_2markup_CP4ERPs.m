...
for m=1:length(S)
    ...
    bcifilename = cat(2,'CP',suj,'_snd.seg.bci'); %
    ...
    markupfilename=cat(2,'CP',suj,'_snd.bpfil.seg.evt') % can use for batch if same filename as seg +.evt
    ...
    outfile= cat(2,'CP',suj,'_trialinfo.mat') % also save .mat structure in case you need further matlab manipulations
