...
%of plots
clear all; clc
clustercode = 'Targ6_4frontiers';
cond1= 'WAmain';
cond2= 'MAmain';
band = 'indAlpha';
% POS cluster, be careful
%freqband= [8 12];
latsnaps = [350 550]; % want snapshots at these latencies for this cluster
zscale = [-0.40 0.40]; % %
%zscale = 'maxmin'; % %
%timelim = [0.208 0.650]; % actual time limits of cluster for box
...
% save SigChan_Targ6n.mat SigChan
