%% The more recent data has a dimord field and also a var field.
% the old tutorial data does not have these...
% i think it went away during blc b/c ft_timelockaverage works with non-blc
