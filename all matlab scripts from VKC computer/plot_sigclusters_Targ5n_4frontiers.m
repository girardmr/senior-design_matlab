...
%of plots
clear all; clc
clustercode = 'Targ5_4frontiers';
cond1= 'WAmain';
cond2= 'IRmain';
band = 'indAlpha';
% POS cluster, be careful
%freqband= [8 12];
latsnaps = [300 450]; % want snapshots at these latencies for this cluster
zscale = [-0.60 0.60]; % %
%zscale = 'maxmin'; % %
%timelim = [0.238 0.654]; % actual time limits of cluster for box

A= 0:2:800; % for targets; must change times for other stim

j = latsnaps/1000;
load Targ_WAvsIR_main_avblc_ind_alf_stat.mat
