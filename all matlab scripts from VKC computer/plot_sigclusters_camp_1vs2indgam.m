...
clustercode = cat(2,'MAPcamp1vs2_',band); % give some abbreviation for your cluster, which will be used to name the graphics files
...
latsnaps = [480 520 560]; % want "snapshots" at these latencies for this cluster - in ms
zscale = [-0.2 0.2]; % determine iteratively
