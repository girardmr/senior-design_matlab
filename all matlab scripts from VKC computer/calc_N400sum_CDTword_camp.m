...
%     cfg.toilim = time;
    ...
    trimdata = ft_selectdata(ERPdata{m},'toilim',time,'channel',centrpost_ch,'avgoverchan','no','avgovertime','no')
...
dlmwrite('CDTword_campers_ERP_N400sum.txt',K,'delimiter','\t','precision','%.4f');
