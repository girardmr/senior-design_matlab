...
for b=1:length(bin)
    ...
    filename = cat(2,'Iversen_',bin{b}, '_allSubj_TLD12Ss_avblc_ind.mat');
    load(filename);
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save dynattiversen_ind_12Ss_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save dynattiversen_ind_12Ss_gam_stat.mat stat
clear stat
