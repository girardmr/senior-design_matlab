...
clustercode = cat(2,'MAPcamp4vs5',band,'4poster'); % give some abbreviation for your cluster, which will be used to name the graphics files
...
latsnaps = [260 340]; % want "snapshots" at these latencies for this cluster - in ms
