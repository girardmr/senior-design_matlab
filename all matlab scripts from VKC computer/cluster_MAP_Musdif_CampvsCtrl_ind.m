...
for b=1:length(bin)
    %
    load(cat(2,'MAP_campers_',bin{b}, '_allSubj_avblc_ind.mat'));
    campers = TFallSubj_ind; 
    clear TFallSubj_ind
    load(cat(2,'MAP_controls_',bin{b}, '_allSubj_avblc_ind.mat'));
    controls = TFallSubj_ind;
...
save MAP_campvsctrl_Musdif_ind_alf_stat.mat stat
clear stat
...
stat.cond1 = 'campers_Musdifwave';
stat.cond2 = 'controls_Musdifwave';
save MAP_campvsctrl_Musdif_ind_beta_stat.mat stat
clear stat
