...
clustercode = cat(2,'MAPcamp1vs2_',band,'4poster'); % give some abbreviation for your cluster, which will be used to name the graphics files
...
latsnaps = [100 300]; % want "snapshots" at these latencies for this cluster - in ms
