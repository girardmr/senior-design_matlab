...
clustercode = cat(2,'MAPcamp4vs6',band); % give some abbreviation for your cluster, which will be used to name the graphics files
...
latsnaps = [240 300 360]; % want "snapshots" at these latencies for this cluster - in ms
