...
clear all; clc
%this one goes from 
band = 'EvoBeta';  %for naming purposes, say ERP here or the name of your frequency band of interest
clustercode = cat(2,'MAPcamp4vs5',band); % give some abbreviation for your cluster, which will be used to name the graphics files
...
% cond2= stat.cond2;
cond1 = 'mus_Match_face'; %
cond2 = 'mus_Mismatch_face'; %

load(cat(2,'MAP_campers_',cond1, '_gravg_avblc_evo.mat'));
% use grand average files
bin1 = TFgravg_evo;
clear TFgravg_evo

load(cat(2,'MAP_campers_',cond2, '_gravg_avblc_evo.mat'));
bin2 = TFgravg_evo;
clear TFgravg_evo
...
latsnaps = [200 260 340]; % want "snapshots" at these latencies for this cluster - in ms
zscale = [-1.4 1.4]; % determine iteratively
