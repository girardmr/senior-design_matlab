...
clustercode = cat(2,'MAPcamp4vs5',band,'4paper'); % give some abbreviation for your cluster, which will be used to name the graphics files
...
zscale = [-0.3 0.3]; % determine iteratively
