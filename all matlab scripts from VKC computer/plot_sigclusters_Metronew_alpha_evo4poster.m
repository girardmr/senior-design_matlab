...
%this one goes frrom 
band = 'Alpha';
clustercode = cat(2,'Metronew_evo_4poster',band);
% POS cluster, be careful
load Metronew_beatvsoff_alf_evo_stat.mat %make sure this is new stat file
cond1= stat.cond1;
cond2= stat.cond2;
