...
clear all; clc
%this one goes from 
band = 'EvoAlpha1';  %for naming purposes, say ERP here or the name of your frequency band of interest
...
latsnaps = [100 200]; % want "snapshots" at these latencies for this cluster - in ms
zscale = [-1.5 1.5]; % determine iteratively
