...
%% NOT SIGNIFICANT - just plot to compare to WS, highlighting turned off

clear all; clc
%this one goes from 
band = 'EvoGam';  %for naming purposes, say ERP here or the name of your frequency band of interest
clustercode = cat(2,'MAPctrl4vs5',band,'4paper_NS'); % give some abbreviation for your cluster, which will be used to name the graphics files

load MAPctrl_4vs5_evo_gam_stat.mat
...
latsnaps = [200 300 400]; % want "snapshots" at these latencies for this cluster - in ms
