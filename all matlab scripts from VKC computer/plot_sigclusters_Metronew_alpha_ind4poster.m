...
%this one goes frrom 
band = 'Alpha';
clustercode = cat(2,'Metronew_ind_4poster_',band);
% POS cluster, be careful
load Metronew_beatvsoff_alf_ind_stat.mat %make sure this is new stat file
cond1= stat.cond1;
cond2= stat.cond2;
...
% 
% end
% save SigChan_MetronewAlpha_ind.mat SigChan
% 

cfg = [];
cfg.channel= 'all'; %ALL SIG ELECTRODES
