...
% mod. by rlg 4 april 2011
% why is it set up for just omitted tones?

clear all;clc
tic
%% define subjects
S{1}='dap_05'; S{2} = 'dap_07';

load hdrtemplate_dap_125_kids.mat %this header template contains sampling rate
