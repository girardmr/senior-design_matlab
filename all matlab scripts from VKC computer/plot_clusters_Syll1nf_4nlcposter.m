...
clear all; clc
clustercode = 'Syll1_4nlcpost';
cond1= 'SSreg';
cond2= 'WSreg';
band = 'indBeta';
% POS cluster, be careful

load SSregvsWSreg_stat_nbeta_ind_f.mat

load Strong_Strong_gravg_mblce.mat
bin1 = TFgravg_ind;
clear TFgravg_ind

load Weak_Strong_gravg_mblce.mat
bin2 = TFgravg_ind;
clear TFgravg_ind
...
%save SigChan_Syll1nf.mat SigChan
