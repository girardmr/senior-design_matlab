...
Reg = load('dap3_regular_gravg_4s_avblc_evo.mat');
...
saveas(gcf, 'gravg4sregularEVO', 'jpg');


%%

Irr = load('dap3_irregular_gravg_4s_avblc_evo.mat');
...
saveas(gcf, 'gravg4sirregularEVO', 'jpg');
