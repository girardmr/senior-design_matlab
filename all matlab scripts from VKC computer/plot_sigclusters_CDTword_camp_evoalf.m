...
clear all; clc
%this one goes from 
band = 'EvoAlpha';  %for naming purposes, say ERP here or the name of your frequency band of interest
...
latsnaps = [60 120 180 240]; % want "snapshots" at these latencies for this cluster - in ms
zscale = [-1 1.5]; % determine iteratively
