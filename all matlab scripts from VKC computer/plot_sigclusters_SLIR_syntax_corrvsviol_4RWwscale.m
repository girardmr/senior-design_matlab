...
clustercode = cat(2,'syntax_corrvsviol_pos_wscale',band); % give some abbreviation for your cluster, which will be used to name the graphics files
...
%900ms
latsnaps = [500 600]; % want "snapshots" at these latencies for this cluster - in ms
