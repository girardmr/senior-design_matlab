...
%define latsnaps and zscale by hand this cluster goes from 34 to 278
latsnaps = [50 150 250]; % want snapshots at these latencies for this cluster in ms
zscale = [-0.05 0.05]; % %
%this one goes from
...
%change name here
save SigChan_MetronewGamma_ind.mat SigChan
