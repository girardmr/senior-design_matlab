...
save SSregvsWSreg_L_stat_beta_evo_rs.mat stat
clear stat
%% SS reg vs. SW reg 
[stat]    = ft_freqstatistics(cfg, data{1}, data{3}); 

save SSregvsSWreg_L_stat_beta_evo_rs.mat stat
clear stat

%% SW reg vs. WW reg
[stat]    = ft_freqstatistics(cfg, data{3}, data{4}); 

save SWregvsWWreg_L_stat_beta_evo_rs.mat stat
clear stat

%% SW reg vs. WS reg
[stat]    = ft_freqstatistics(cfg, data{3}, data{2}); 

save SWregvsWSreg_L_stat_beta_evo_rs.mat stat
clear stat
...
save SSregvsWSreg_L_stat_logam_evo_rs.mat stat
clear stat
%% SS reg vs. SW reg 
[stat]    = ft_freqstatistics(cfg, data{1}, data{3}); 

save SSregvsSWreg_L_stat_logam_evo_rs.mat stat
clear stat

%% SW reg vs. WW reg
[stat]    = ft_freqstatistics(cfg, data{3}, data{4}); 

save SWregvsWWreg_L_stat_logam_evo_rs.mat stat
clear stat

%% SW reg vs. WS reg
[stat]    = ft_freqstatistics(cfg, data{3}, data{2}); 

save SWregvsWSreg_L_stat_logam_evo_rs.mat stat
clear stat
