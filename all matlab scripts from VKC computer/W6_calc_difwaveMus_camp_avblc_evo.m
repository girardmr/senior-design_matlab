% calculate difference waves evoked  W6 mus data
...
for m=1:length(S)
    ...
    New=cond1;
    New.TFRwave_evo.powspctrm = cond1.TFRwave_evo.powspctrm - cond2.TFRwave_evo.powspctrm; % Happy vs Sad
    TFRwave_evo = New.TFRwave_evo;
    
    % name file
    outfile= cat(2,suj,'_MAP_MusDifwave_avblc_evo.mat')
