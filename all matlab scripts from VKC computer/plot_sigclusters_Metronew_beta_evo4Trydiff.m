...
%this one goes frrom 
band = 'Beta';
clustercode = cat(2,'Metronew_evo_4try_',band);
...
latsnaps = [-50 0 100 150 200 250]; % want snapshots at these latencies for this cluster in ms
zscale = [-2 2]; % %
%this one goes from 
...
save SigChan_MetronewBeta_evo.mat SigChan
