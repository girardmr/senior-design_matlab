...
%         
        ...
        outfilename = cat(2,suj,bin{b},' evoked multichan avblc')
...
%     end
    ...
    outfilename = cat(2,suj,' evoked beta topo avblc')
...
%     end
    ...
    outfilename = cat(2,suj,' evoked gamma topo avblc')
