...
Reg = load('dap3_regular_gravg_4s_avblc_ind.mat');
...
saveas(gcf, 'gravg4sregularind', 'jpg');


%%

Irr = load('dap3_irregular_gravg_4s_avblc_ind.mat');
...
saveas(gcf, 'gravg4sirregularind', 'jpg');
