...
for m=1:length(S)
    ...
    markupfilename=cat(2,'MarkupBCI_chordsTut_subj',suj,'.txt')
    ...
    outfile= cat(2,'subj',suj,'_chordstut_trialinfo.mat') % also save .mat structure in case you need further matlab manipulations
