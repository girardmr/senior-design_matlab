...
for b=1:length(bin)
    ...
    filename = cat(2,'MAP_campers_',bin{b}, '_allSubj_avblc_evo.mat');
    load(filename);
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save MAPcamp_1vs2_evo_alf_stat.mat stat
...
stat.cond1 = bin{2};
stat.cond2 = bin{3};%
save MAPcamp_2vs3_evo_alf_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{3};%
save MAPcamp_1vs3_evo_alf_stat.mat stat
clear stat

%% FACES
[stat]    = ft_freqstatistics(cfg, data{4}, data{5}); %
save MAPcamp_4vs5_evo_alf_stat.mat stat
stat.cond1 = bin{4};
stat.cond2 = bin{5};
clear stat
%%
...
stat.cond1 = bin{5};
stat.cond2 = bin{6};%
save MAPcamp_5vs6_evo_alf_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{6};%
save MAPcamp_4vs6_evo_alf_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save MAPcamp_1vs2_evo_beta_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{2}, data{3}); 
stat.cond1 = bin{2};
stat.cond2 = bin{3};%
save MAPcamp_2vs3_evo_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{3};%
save MAPcamp_1vs3_evo_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{5};
save MAPcamp_4vs5_evo_beta_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{5}, data{6}); 
stat.cond1 = bin{5};
stat.cond2 = bin{6};%
save MAPcamp_5vs6_evo_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{6};%
save MAPcamp_4vs6_evo_beta_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{2};
save MAPcamp_1vs2_evo_gam_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{2}, data{3}); 
stat.cond1 = bin{2};
stat.cond2 = bin{3};%
save MAPcamp_2vs3_evo_gam_stat.mat stat
clear stat
...
stat.cond1 = bin{1};
stat.cond2 = bin{3};%
save MAPcamp_1vs3_evo_gam_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{5};
save MAPcamp_4vs5_evo_gam_stat.mat stat
clear stat
%%
[stat]    = ft_freqstatistics(cfg, data{5}, data{6}); 
stat.cond1 = bin{5};
stat.cond2 = bin{6};%
save MAPcamp_5vs6_evo_gam_stat.mat stat
clear stat
...
stat.cond1 = bin{4};
stat.cond2 = bin{6};%
save MAPcamp_4vs6_evo_gam_stat.mat stat
clear stat
