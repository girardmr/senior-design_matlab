...
clustercode = cat(2,'syntax_1vs2_neg_',band); % give some abbreviation for your cluster, which will be used to name the graphics files
...
latsnaps = [250 300 350]; % want "snapshots" at these latencies for this cluster - in ms
