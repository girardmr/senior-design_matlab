...
for m=1:length(S) %for each subject
    ...
    filename= cat(2,'MAP_',suj,'_avgAudBins_tfr_evo.mat')
    load(filename)
...
save MAP_controls_AudBins_avg_base_evo.mat avgbase_sepch
clear avgbase_sepch
...
for m=1:length(S) %for each subject
    ...
    filename= cat(2,'MAP_',suj,'_avgFaceBins_tfr_evo.mat')
    load(filename)
...
save MAP_controls_FaceBins_avg_base_evo.mat avgbase_sepch
clear avgbase_sepch
