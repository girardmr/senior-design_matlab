...
%         SR = data.fsample;
        ...
        cfg.output  = 'pow';
        cfg.foi     = 4:2:53; %frequencies of interest - try step of 2Hz here
        cfg.toi     = -0.650:timestep:0.650;    %time of interest CAREFUL - time in seconds, 4ms
        cfg.keeptrials = 'no'; %return individual trials or average (default = 'no') (default = 'no')

        TFRwave_evo = ft_freqanalysis(cfg, data_ERP);
        
        outfile= cat(2,suj,'_',bin{b},'_long_tfr_evo.mat')
