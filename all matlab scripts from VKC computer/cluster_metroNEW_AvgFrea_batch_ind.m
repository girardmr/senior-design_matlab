%cluster analysis for syllables - INDUCED - batch for beta, logamma,
...
for b=1:length(bin)
    ...
    filename = cat(2,bin{b}, '_allSubj_avblc_ind.mat');
    load(filename);
...
stat.cond1 = bin{1}
stat.cond2 = bin{2}
save Metronew_beatvsoff_af_theta_ind_stat.mat stat
clear stat
...
stat.cond1 = bin{1}
stat.cond2 = bin{2}
save Metronew_beatvsoff_af_alf_ind_stat.mat stat
clear stat
...
stat.cond1 = bin{1}
stat.cond2 = bin{2}
save Metronew_beatvsoff_af_beta_ind_stat.mat stat
clear stat
...
stat.cond1 = bin{1}
stat.cond2 = bin{2}
save Metronew_beatvsoff_af_logam_ind_stat.mat stat
clear stat