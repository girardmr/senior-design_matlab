...
condname{4}='Happy Music + Happy Face';
condname{5}='Sad Music + Happy Face';
condname{6}='Neutral Sound + Happy Face';
condname{7}='Happy Music + Sad Face';
condname{8}='Sad Music + Sad Face';
condname{9}='Neutral Sound + Sad Face';
