...
clustercode = cat(2,'MAPcamp1vs3_',band); % give some abbreviation for your cluster, which will be used to name the graphics files
...
latsnaps = [60 120 180]; % want "snapshots" at these latencies for this cluster - in ms
