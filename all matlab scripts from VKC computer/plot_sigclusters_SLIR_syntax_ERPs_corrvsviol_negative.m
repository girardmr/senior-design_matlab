...
clustercode = cat(2,'syntax_corrvsviol_neg_',band); % give some abbreviation for your cluster, which will be used to name the graphics files

load SLIR_syntax_both_ERP_stat.mat % make sure you load the right stat file
...
latsnaps = [200 250 300 350]; % want "snapshots" at these latencies for this cluster - in ms
