...
%this one goes from 
band = 'Alpha';
clustercode = cat(2,'tut_Chords2vs3_evo_',band);

load Chords_2vs3_avblc_evo_alf_stat.mat %make sure this is new stat file
cond1= stat.cond1;
cond2= stat.cond2;

load(cat(2,cond1, '_chords_gravg_avblc_evo.mat'));
bin1 = TFgravg_evo;
clear TFgravg_evo

load(cat(2,cond2, '_chords_gravg_avblc_evo.mat'));
bin2 = TFgravg_evo;
clear TFgravg_evo
...
latsnaps = [180 260 340]; % want snapshots at these latencies for this cluster - in ms
