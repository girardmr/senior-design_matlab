...
for b=1:length(bin)
    ...
    filename = cat(2,bin{b}, '_S_allSubj_mblc_evo_rs.mat'); % new analyses with longer syll epochs
    load(filename);
...
save SSregvsWSreg_S_stat_beta_evo_rs_f.mat stat
clear stat
%% SS reg vs. SW reg 
[stat]    = ft_freqstatistics(cfg, data{1}, data{3}); 

save SSregvsSWreg_S_stat_beta_evo_rs_f.mat stat
clear stat

%% SW reg vs. WW reg
[stat]    = ft_freqstatistics(cfg, data{3}, data{4}); 

save SWregvsWWreg_S_stat_beta_evo_rs_f.mat stat
clear stat

%% SW reg vs. WS reg
[stat]    = ft_freqstatistics(cfg, data{3}, data{2}); 

save SWregvsWSreg_S_stat_beta_evo_rs_f.mat stat
clear stat
...
save SSregvsWSreg_S_stat_logam_evo_rs_f.mat stat
clear stat
%% SS reg vs. SW reg 
[stat]    = ft_freqstatistics(cfg, data{1}, data{3}); 

save SSregvsSWreg_S_stat_logam_evo_rs_f.mat stat
clear stat

%% SW reg vs. WW reg
[stat]    = ft_freqstatistics(cfg, data{3}, data{4}); 

save SWregvsWWreg_S_stat_logam_evo_rs_f.mat stat
clear stat

%% SW reg vs. WS reg
[stat]    = ft_freqstatistics(cfg, data{3}, data{2}); 

save SWregvsWSreg_S_stat_logam_evo_rs_f.mat stat
clear stat
